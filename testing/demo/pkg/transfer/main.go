...
import (
	...
	"github.com/celestiaorg/celestia-zkevm-ibc-demo/testing/demo/pkg/sp1-gnark/babybear"
	"github.com/celestiaorg/celestia-zkevm-ibc-demo/testing/demo/pkg/utils"
	"github.com/consensys/gnark-crypto/ecc"
	// gnark "github.com/consensys/gnark/backend/groth16"
	"github.com/consensys/gnark/frontend"

	sp1gnark "github.com/celestiaorg/celestia-zkevm-ibc-demo/testing/demo/pkg/sp1-gnark"
...
func transferBack() error {
	...
	if err != nil {
		return fmt.Errorf("failed to generate state transition public witness: %w", err)
	}
