...
replace (
	github.com/berachain/beacon-kit/mod/consensus-types => github.com/rollkit/beacon-kit/mod/consensus-types v0.0.0-20240703163532-61fa0fb6e7b3
	github.com/berachain/beacon-kit/mod/primitives => github.com/rollkit/beacon-kit/mod/primitives v0.0.0-20240703163532-61fa0fb6e7b3
)
